 ...
 * Implements 7 compression layers.
 *
 * Usage:
...
import type { CompressionConfig } from "../router/types.js";
import { DEFAULT_COMPRESSION_CONFIG } from "../router/types.js";
...
export type { NormalizedMessage, CompressionResult, CompressionStats } from "./types.js";
export type { ContentPart, ToolCall } from "./types.js";
 ...
 * 6. Observation - Compress tool results
 * 7. Dynamic Codebook - Learn repeated phrases from content
 *
...
export async function compressContext(
  ...
  // Layer 6: Observation compression
